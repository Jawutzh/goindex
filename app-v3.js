 ...
 */
// 在head 中 加载 必要静态
document.write('<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/jawutzh/goindex/css/mdui_v2.min.css">');
document.write('<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/jawutzh/goindex/css/nexmoe_v2.min.css">');
document.write('<script src="//cdn.jsdelivr.net/gh/jawutzh/goindex/js/mdui.min.js"></script>');
document.write('<script src="//cdn.jsdelivr.net/gh/jawutzh/goindex/js/flv.min.js"></script>');
document.write('<script src="//cdn.jsdelivr.net/gh/jawutzh/goindex/js/DPlayer.min.js"></script>');
// markdown支持
document.write('<script src="//cdn.jsdelivr.net/gh/jawutzh/goindex/js/markdown-it.min.js"></script>');
...
<header class="nexmoe-nav">
	<div class="navSize">
			...
			<div class="nav_menu">
				<ul class="menu_ul">
					<li class="menu_li"><a href="https://khian.xyz/" target="_blank">博客</a></li>
...
<script src="//cdn.jsdelivr.net/gh/jawutzh/goindex/js/ace.js"></script>
<script src="//cdn.jsdelivr.net/gh/jawutzh/goindex/js/ext-language_tools.js"></script>
	`;
  $('#content').html(content);
